...
Full documentation lives in the `docs/` folder and is published at [https://alangunning.github.io/doc-ai-analysis/docs/](https://alangunning.github.io/doc-ai-analysis/docs/).
...
3. **Configure**
   ...
   [Configuration guide](https://github.com/alangunning/doc-ai-analysis/blob/main/docs/content/guides/configuration.md)
...
Guides for each part of the template live in the `docs/` folder and are published at [https://alangunning.github.io/doc-ai-analysis/docs/](https://alangunning.github.io/doc-ai-analysis/docs/). Useful starting points:

- [Introduction](https://alangunning.github.io/doc-ai-analysis/docs/content/intro) – project overview and navigation
- [Workflow Overview](https://alangunning.github.io/doc-ai-analysis/docs/content/workflows) – how the GitHub Actions fit together
- [CLI Scripts and Prompts](https://alangunning.github.io/doc-ai-analysis/docs/content/scripts-and-prompts) – run conversions and analyses locally
- [Converter Module](https://alangunning.github.io/doc-ai-analysis/docs/content/converter) – programmatic file conversion
- [GitHub Module](https://alangunning.github.io/doc-ai-analysis/docs/content/github) – helpers for GitHub Models
- [OpenAI Module](https://alangunning.github.io/doc-ai-analysis/docs/content/openai) – reusable file and response helpers
- [Metadata Module](https://alangunning.github.io/doc-ai-analysis/docs/content/metadata) – track processing state
- [Configuration](https://alangunning.github.io/doc-ai-analysis/docs/content/configuration) – environment variables and model settings
- [Pull Request Reviews](https://alangunning.github.io/doc-ai-analysis/docs/content/pr-review) – automate AI feedback on PRs
- [Plugin System](https://alangunning.github.io/doc-ai-analysis/docs/content/doc_ai/plugins) – extend the CLI with custom commands, REPL commands, and completion providers; see [docs/content/examples/plugin_example.py](docs/content/examples/plugin_example.py) for a template
...
Each run updates the companion metadata so completed steps are skipped. See the [metadata docs](https://alangunning.github.io/doc-ai-analysis/docs/content/metadata) for a full overview of the schema and available fields. Configure which steps run using the environment variables described in the [Configuration guide](https://github.com/alangunning/doc-ai-analysis/blob/main/docs/content/guides/configuration.md).
