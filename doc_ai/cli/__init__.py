...
def cd(ctx: typer.Context, path: Path | None = typer.Argument(None)) -> None:
    ...
    try:  # pragma: no cover - defensive
        ...
        logger.debug("Failed to update ENV_FILE on config module: %s", exc)
...
new_app.command("edit-topic")(new_topic_cmd.edit_topic)
...
new_app.command("edit-doc-type")(new_doc_type_cmd.edit_doc_type)
